...
import { Navigation, AlertTriangle, Flame, Tent, Wind, Layers, Info } from "lucide-react";
...
export default function SVGMapView({ onItemClick, selectedItem }: SVGMapViewProps) {
        ...
        <div className="relative w-72 h-[400px]">
          ...
          >
            ...
            {layers.tcHazard && (
              <g className="opacity-80">
                ...
                <g
                  ...
                  onClick={() => handleItemClick(tcHazardZone)}
                >
                  <circle cx="0" cy="0" r="6" className="fill-rose-600 animate-ping opacity-75" />
            ...
            {layers.centers && (
              <g>
                {/* Port Vila (Shefa) */}
                <g className="cursor-pointer" onClick={() => handleItemClick(evacuationCenters[0])}>
                  <circle
                    cx="112"
                    cy="182"
                    r="5"
                ...
                {/* Luganville (Sanma) */}
                <g className="cursor-pointer" onClick={() => handleItemClick(evacuationCenters[1])}>
                  <circle
                    cx="46"
                    cy="85"
                    r="5"
                    className="fill-emerald-500 animate-pulse opacity-90"
                  />
                  <circle cx="46" cy="85" r="3.5" className="fill-emerald-600 stroke-emerald-100" />
                </g>

                {/* Isangel (Tafea) */}
                <g className="cursor-pointer" onClick={() => handleItemClick(evacuationCenters[2])}>
                  <circle
                    cx="142"
                    cy="254"
                    r="5"
                  ...
                  />
                  <circle cx="142" cy="254" r="3.5" className="fill-amber-600 stroke-amber-100" />
                </g>

                {/* Lakatoro (Malampa) */}
                <g className="cursor-pointer" onClick={() => handleItemClick(evacuationCenters[3])}>
                  <circle
                    cx="62"
                    cy="125"
                    r="5"
          ...
          {selectedItem ? (
            <div className="p-4 rounded-xl border border-primary/20 bg-primary/5 space-y-3 animate-fadeIn relative">
              <div className="flex justify-between items-start">
                ...
                <button
                  onClick={() => onItemClick?.(null as any)}
