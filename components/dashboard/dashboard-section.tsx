...
export default function DashboardSection() {
    ...
    return [
      {
        ...
        value: s.estimated_idp.toLocaleString(),
        icon: Users,
      ...
      },
      {
        ...
        value: s.evacuation_centres.toLocaleString(),
        icon: Tent,
      ...
      },
      {
        key: "hhs",
        label: "Affected HHs",
        value: s.affected_hhs.toLocaleString(),
        icon: Home,
        category: "Displacement",
      },
      {
        ...
        value: s.villages_assessed.toLocaleString(),
        icon: MapPin,
        category: "Summary",
      },
      {
        key: "shelter",
        label: "Shelter Needs",
        value: s.shelter_needs.toLocaleString(),
        icon: Home,
        category: "Shelter",
      },
      {
        ...
        value: `${s.access_to_basic_services}%`,
        icon: Heart,
      ...
      },
      {
        ...
        value: s.children_affected.toLocaleString(),
        icon: Baby,
        category: "Protection",
      },
      {
        ...
        value: s.person_with_disabilities.toLocaleString(),
        icon: Accessibility,
        category: "Protection",
      },
      {
        ...
        icon: Handshake,
        category: "Response Tracking",
      },
      {
        key: "coverage",
        label: "Response Coverage",
        value: `${s.response_coverage}%`,
        icon: Activity,
        category: "Response Tracking",
      },
    ];
  ...
  const evacuationCentres = useMemo(() => {
    const defaultCentres = [
      {
        province: "Shefa",
        site: "Port Vila Area Council Hall",
        status: "Open",
        hhs: 220,
        type: "Community Hall",
      },
      {
        province: "Sanma",
        site: "Luganville Community Centre",
        status: "Open",
        hhs: 185,
        type: "School",
      },
      ...
      {
        province: "Penama",
        site: "Ranwadi College Gymnasium",
        status: "Closed",
        hhs: 0,
        type: "School",
      },
  ...
  const responseTracking = useMemo(() => {
    const defaultTracking = [
      {
        sector: "Shelter/NFI",
        partner: "IOM / Partners",
        coverage: 68,
        status: "Ongoing",
      },
      {
        sector: "WASH",
        partner: "Cluster Partners",
        coverage: 54,
        status: "Critical Need",
      },
      {
        sector: "Protection",
        partner: "DECM Partners",
        coverage: 46,
        status: "Underfunded",
      },
      {
        sector: "Access to Basic Services",
        partner: "NDMO / Partners",
        coverage: 64,
        status: "Ongoing",
      },
    ];
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2.5">
                    <Icon
                      className={`w-4 h-4 ${isActive ? "text-primary-foreground" : "text-muted-foreground/60"}`}
                    />
