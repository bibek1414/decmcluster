...
import {
  useFiveWImports,
  useUploadFiveWImport,
  useDeleteFiveWImport,
  useReverifyFiveWImport,
  useUploadNewFiveWImport,
} from "@/hooks/use-fivew-imports";
...
export default function FiveWImportsClient() {
  ...
  // Fetch 5W imports list
  const { data, isLoading, isPlaceholderData, error } = useFiveWImports(
    page,
    token,
    debouncedSearch,
  );
  ...
  // Mutations
  const uploadMutation = useUploadFiveWImport();
  const deleteMutation = useDeleteFiveWImport();
  const reverifyMutation = useReverifyFiveWImport();
  const uploadNewMutation = useUploadNewFiveWImport();
  ...
  const handleUploadSubmit = (e: React.FormEvent) => {
    ...
    uploadMutation.mutate(
      ...
      {
        onSuccess: () => {
          toast.success("5W import file uploaded successfully!");
          setIsUploadOpen(false);
          setUploadName("");
  ...
  return (
    <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fadeIn relative">
      <div className="bg-transparent sm:bg-card text-card-foreground sm:rounded-2xl p-0 sm:p-6 md:p-8 border-0 sm:border border-border space-y-6">
        ...
        <PageHeader
          title="5W Response Data Imports"
          description={
            <div className="flex flex-col gap-0.5">
              <span>Upload, manage, and verify 5W response activity spreadsheets</span>
            </div>
          }
          actions={
            canAdd && (
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="relative min-w-0 flex-1">
            ...
            <Input
              ...
              placeholder="Search 5W imports by name..."
        ...
        <div className="relative min-h-[200px]">
          {isLoading || isPlaceholderData ? (
            ...
            <EmptyState
              ...
              title="No 5W response imports found"
              description={
                canAdd
                  ? "Upload your first 5W activity Excel/CSV list to submit for verification."
                  : "No 5W activity imports have been uploaded yet."
              }
              action={
                canAdd ? (
                  <Button
                          ...
                          <div className="inline-flex items-center gap-2">
                            ...
                            {isSuperAdmin && (
                              <Button
                                ...
                                asChild
                              >
                                <Link href={`/fivew-imports/verify/${item.id}`}>Review</Link>
                              </Button>
                            )}
        ...
        >
          ...
          >
            <div className="flex items-center justify-between border-b border-border pb-3">
              <h3 className="text-base font-bold text-foreground">Upload 5W Response Import</h3>
              <Button
                variant="ghost"
                size="icon"
                onClick={() => setIsUploadOpen(false)}
            ...
            <form onSubmit={handleUploadSubmit} className="space-y-4">
              <div className="space-y-1">
                ...
                <Input
                  ...
                  placeholder="e.g. 5W Response Matrix Q3 2026"
