...
export default function TrainingPage() {
  const modules = [
    {
      title: "Module 1: Introduction to DECM Standards",
      hours: "2 hrs",
      difficulty: "Beginner",
    },
    {
      title: "Module 2: Field Enumeration using KoboCollect",
      hours: "4 hrs",
      difficulty: "Intermediate",
    },
    {
      title: "Module 3: GIS Coordinates Mapping on Mobile",
      hours: "3.5 hrs",
      difficulty: "Intermediate",
    },
    {
      title: "Module 4: Cluster Response Coordination & Reporting",
      hours: "5 hrs",
      difficulty: "Advanced",
    },
  ];
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {modules.map((mod, idx) => (
              <div
                key={idx}
                className="p-4 rounded-xl border border-border bg-card hover:bg-muted/40 transition-colors flex items-center justify-between gap-4"
              >
                <div>
                  ...
                  <p className="text-[10px] text-muted-foreground mt-1">
                    Duration: {mod.hours} | Level: {mod.difficulty}
                  </p>
                </div>
