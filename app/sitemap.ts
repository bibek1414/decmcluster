...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    { path: "/mapping", changeFrequency: "daily", priority: 0.9 },
    ...
    { path: "/emergency-alerts", changeFrequency: "always", priority: 0.8 },
    { path: "/announcements", changeFrequency: "daily", priority: 0.7 },
    { path: "/latest-updates", changeFrequency: "daily", priority: 0.7 },
    { path: "/powerbi-dashboards", changeFrequency: "weekly", priority: 0.7 },
    { path: "/historical-events", changeFrequency: "monthly", priority: 0.6 },
