...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 py-16 text-center bg-background">
      ...
      <h2 className="text-6xl font-extrabold text-foreground tracking-tight sm:text-7xl ">
        404
      </h2>
      <h3 className="mt-2 text-2xl font-bold text-muted-foreground sm:text-3xl">
        Page Not Found
      </h3>
      <p className="mt-4 text-muted-foreground max-w-md mx-auto text-sm sm:text-base leading-relaxed">
        ...
        temporarily unavailable. Let's guide you back.
      </p>
